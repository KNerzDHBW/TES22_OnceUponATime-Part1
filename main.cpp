...
int main() {
   ...
   */
  std::cout << std::endl
            << "Die Maerchen von TES22 -- Band 1" << std::endl
            << std::endl;
  /*
   * Erstes Kapitel
   */
   ...
   * Drittes Kapitel
   */
  std::cout << std::endl << "Das Traumfresserchen" << std::endl << std::endl;
 ...
 /*
   * Sechsts Kapitel
   */
  std::cout << "Der tapfere kleine Frosch" << std::endl
            << std::endl;

  std::cout
      << "Ein kleiner Frosch wagte sich mutig in den gefährlichen Wald, um seinen Freunden das rettende Wasser zu bringen."
      << std::endl
      << std::endl; // erster Satz, neue Sätze in diesem Kapitel erst
                    // unter diesem Satz
